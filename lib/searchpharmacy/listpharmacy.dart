...
class PharmacyList extends StatelessWidget {
  ...
  PharmacyList({Key key, this.pharmacy, this.yolatitude, this.yolongitude})
      : super(key: key);
              ...
              children: <Widget>[
                ListTile(
                  leading: CircleAvatar(
                      ...
                      backgroundImage:
                          NetworkImage(pharmacy[index].pharmacy_logo)),
                  title:
                      Text(pharmacy[index].pharmacy_name ?? 'No Pharmacy Name'),
                  subtitle: Text(
                    pharmacy[index].address ??
                        'No Address Found!' + ", " + pharmacy[index].city ??
                        'No City Found!',
                    overflow: TextOverflow.ellipsis,
                  ),
                  trailing: (this.yolatitude != null &&
                          this.yolongitude != null)
